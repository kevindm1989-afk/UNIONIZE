...
export default function MemberPortalRights() {
        ...
        <div className="flex-1 px-4 py-4 space-y-4">
          ...
          <div className="space-y-3">
            ...
            <p className="text-[10px] text-muted-foreground/60 text-center">
              This AI assistant explains the CBA and ESA. It is not legal advice. Always verify with your steward for serious matters.
            </p>
          </div>
            ...
            <div className="space-y-3" ref={historyRef}>
              <div className="flex items-center gap-2">
                ...
                <p className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground">
                  {history.length === 1 ? "Your Answer" : `${history.length} Answers`}
                </p>
                <div className="flex-1 h-px bg-border" />
              </div>
          ...
          {history.length === 0 && !loading && (
            <div className="text-center py-8">
              ...
              <p className="text-sm font-semibold text-foreground">Understand your workplace rights</p>
              <p className="text-xs text-muted-foreground mt-1 max-w-[240px] mx-auto">
                Ask any question about your rights under the Collective Agreement or Ontario ESA. Tap a chip above to get started.
              </p>
            </div>
          )}
        </div>
