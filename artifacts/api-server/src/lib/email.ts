  ...
  await send({
    ...
    html: `
      <div style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:24px;">
        ...
        <p style="margin-top:24px;font-size:12px;color:#aaa;">JHSC Advisor</p>
      </div>
    `,
    text: [
      "New Access Request — JHSC Advisor",
      "",
...
export async function sendAccessRequestApprovedEmail(opts: {
  ...
  await send({
    ...
    html: `
      <div style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:24px;">
        <h2 style="margin:0 0 8px;font-size:20px;color:#111;">Welcome to JHSC Advisor!</h2>
    ...
    `,
    text: [
      `Welcome to JHSC Advisor, ${opts.recipientName}!`,
      "",
